export const experience = [
  ...
  {
    role: 'Program Management Fellow',
    company: 'BuildUp Global',
    period: 'December 2025 – February 2026',
    points: [
      'Handled company meetings, coordinated with mentors and client stakeholders, and ensured smooth project execution.',
      'Managed student teams, monitored progress, and maintained overall program workflow in a virtual setup.',
    ],
  },
  {
  ...
  {
    role: 'User Acceptance Testing Intern',
    company: 'MAIDC',
    period: 'January 2024 – May 2024',
    points: [
      'Testing bugs and errors on the official website of Maha-Agro Mart.',
